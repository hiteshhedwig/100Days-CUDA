...
def combine_results():
    ...
    cuda_df = pd.read_csv('build/benchmark_results_mat_vec_mul_opt.csv')
    ...
    pytorch_df = pd.read_csv('build/pytorch_benchmark_matrix_vector_mul_results.csv')
...
def create_execution_time_plot(df):
    ...
    plt.title('Matrix-Vector Multiplication Performance Comparison', fontsize=16)
    ...
    plt.tight_layout()
    plt.savefig('matrix_vec_mul_execution_time_comparison.png', dpi=300)
    print("Created execution time plot: matrix_vec_mul_execution_time_comparison.png")
...
def create_speedup_plot(df):
    ...
    plt.title('Matrix-Vector Multiplication Relative Performance Comparison', fontsize=16)
    ...
    plt.tight_layout()
    plt.savefig('matrix_vec_mul_speedup_comparison.png', dpi=300)
    print("Created speedup plot: matrix_vec_mul_speedup_comparison.png")
