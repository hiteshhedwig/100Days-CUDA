...
def combine_results():
    ...
    cuda_df = pd.read_csv('build/benchmark_results_mat_mat_mul_opt.csv')
    ...
    pytorch_df = pd.read_csv('build/pytorch_benchmark_matmul_results.csv')
...
def create_execution_time_plot(df):
    ...
    plt.title('Matrix Multiplication - Tiled Performance Comparison', fontsize=16)
