...
def run_pytorch_benchmarks():
    ...
    df.to_csv(f'build/pytorch_benchmark_scalar_mul_results.csv', index=False)
    print("PyTorch benchmark complete. Results saved to pytorch_benchmark_scalar_mul_results.csv")
    return df
